                ...
                template += `   <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            <a href="/desk/`+item.id+`" class="product-thumbnail">
                                                <img src="`+item.cover+`" alt="Product Images" height="300">
                                            </a>
                                            <div class="product-actions">
                                                <a href="/desk/`+item.id+`"><i class="p-icon icon-plus"></i><span class="tool-tip">Quick View</span></a>
                                                <a href="#"><i class="p-icon icon-bag2"></i> <span class="tool-tip">Add to cart</span></a>
                                            </div>
                                        </div>
                                        <div class="product-content">
                                            <h6 class="product-title">
                                                <a href="/desk/`+item.id+`">`+item.title+`</a>
                                            </h6>
                                            <small class="text-color-primary">`+item.design+`</small>
